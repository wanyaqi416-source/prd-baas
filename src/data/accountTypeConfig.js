...
const bhReceivingAccount = receivingAccount({
  beneficiaryName: 'FIDERE TRUST LIMITED',
  bankName: '',
  accountNumber: '',
  bankAddress: 'Manama, Kingdom of Bahrain',
  receivingBank: '',
  swiftCode: '',
})
...
export const initialAccountTypeConfigs = [
  {
    ...
    code: 'HK_ACCOUNT',
    clientDescription: '用于日常多币种资金管理、入金、出金及账户间资金划转。',
    openingFeeAmount: 0,
  ...
  },
  {
    ...
    code: 'US_ACCOUNT',
    clientDescription: '面向有美元收付款需求的客户，申请提交后进入资料审核流程。',
  ...
  },
  {
    ...
    code: 'SG_ACCOUNT',
    clientDescription: '支持多币种收付款与资产管理，确认开户费用后进入审核流程。',
    openingFeeAmount: 1000,
    openingFeeCurrency: 'USD',
    status: '启用',
    clientVisible: true,
    requiresDocuments: false,
  ...
  },
  {
    ...
    code: 'BH_ACCOUNT',
    clientDescription: '面向中东地区资金管理需求，支持美元及巴林第纳尔账户服务。',
    openingFeeAmount: 750,
    openingFeeCurrency: 'USD',
    status: '启用',
    clientVisible: true,
    requiresDocuments: false,
    ...
    updatedBy: '运营管理员',
    receivingAccount: bhReceivingAccount,
    currencies: [
      {
        code: 'USD',
        name: '美元',
        ...
        banks: [
          bank('BH-USD-001', {
            beneficiaryName: bhReceivingAccount.beneficiaryName,
            bankName: bhReceivingAccount.bankName,
            bankAddress: bhReceivingAccount.bankAddress,
            accountNumber: bhReceivingAccount.accountNumber,
            receivingBank: bhReceivingAccount.receivingBank,
            swiftBic: bhReceivingAccount.swiftCode,
            remark: '巴林账户 USD 收款银行信息待运营配置。',
          }),
        ],
      },
      {
