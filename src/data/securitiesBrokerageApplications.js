...
export const initialBrokerageApplications = [
  ...
  },
  {
    ...
    statusLogs: [
      { id: 'log-006-1', time: '2026-06-22 09:18', operator: '客户', from: '-', to: '审核中', remark: '客户提交 IBKR 开户申请，等待后台审核资料。' },
    ],
    accountInfo: null,
  },
  {
  ...
  },
  {
    ...
    statusLogs: [
      { id: 'log-004-1', time: '2026-06-21 09:32', operator: '客户', from: '-', to: '审核中', remark: '客户提交 IBKR 开户申请，等待后台审核资料。' },
    ],
    accountInfo: null,
  },
  {
